...
function test() {
  ...
  begintimer = 15900, $(document).ready(function() {
    var t = new Date,
      e = parseInt(t.getDate());
    localStorage.getItem("___bt") ? (tm = parseInt(localStorage.getItem("___tm")), e - tm == 0 ? bt = localStorage.getItem("___bt") : (bt = begintimer, localStorage.setItem("___bt", bt))) : (bt = begintimer, localStorage.setItem("___bt", bt)), $(".test-form-btn").on("click", function() {
        var t = test(),
          e = 0;
        return 1 == t && ($(".result-header").html("ความเสี่ยงต่ำ"), $(".result-text").html("ยังไม่สามารถบอกด้วยความมั่นใจได้ว่าท่านเป็นโรคต่อมลูกหมากอักเสบหรือไม่ แต่ถ้าท่านครบอายุ 30 ปีแล้ว ควรจะดูแลต่อมลูกหมากของท่านด้วยคอร์สป้องกันผลิตภัณฑ์ Diforol คอร็สนี้จะช่วยป้องกันไม่ให้เกิดผลข้างเคียงต่างๆของโรคนี้"), e = "140px"), 2 == t && ($(".result-header").html("ความเสี่ยงสูงกว่าระดับกลาง"), $(".result-text").html("ถ้าท่านครบอายุ 30-35 ปีขึนไปแล้ว มีโอกาสสูงว่าท่านเป็นโรคต่อมลูกหมากอักเสบในรูปแบบที่ไม่เปิดเผย อาการที่ท่านมีเป็นสัญลักษณ์พิสูจน์ได้ ท่านควรจะเริ่มแก้ปัญหาทันที ไม่อย่างนั้นถ้าปล่อยให้โรคเติบโตไปอย่างต่อเนื่องจะต้องเกิดผลสุดท้ายที่น่ากลัวรวมถึงต้องเสียสมรรถภาพทางเพศหรืออาจจะต้องผ่าตัดต่อมลูกหมากออก ถ้าท่านเคยใช้ผลิตภัณฑ์อื่นๆแล้วแต่ไม่ได้ผล ท่านควรลองใช้ Diforol "), e = 280), t >= 3 && t <= 5 && ($(".result-header").html("ระวัง ความเสี่ยงสูง"), $(".result-text").html("ท่านควรระวังเพราะมีความเสี่ยงสูง อย่าเสียเวลาอีกและต้องรีบแก้ปัญหาก่อนที่จะเกิดเยื่อพังผืด คือการเปลี่ยนแปลงของเนื้อเยื่อปกติของต่อมลูกหมากให้เป็นเนื้อเยื่อเกี่ยวพันซึ่งถือว่าเป็นการเสื่อมสภาพของต่อมลูกหมากแบบถาวร ถ้าท่านต้องการรักษาความเป็นผู้ชายของท่านตลอดชีวิต ท่านควรจะเริ่มรับ Diforol อย่าล่าช้าเลย"), e = 420), t >= 6 && ($(".result-header").html("ขั้นอันตราย"), $(".result-text").html("ท่านเป็นโรคต่อมลูกหมากอักเสบแล้วแน่นอน และดูจากอาการแล้วโรคน่าจะเติบโตได้ไกลแล้ว คือท่านน่าจะเป็นโรคนี้มาเป็นเวลาหลายๆปีซึ่งอาจทำให้เกิดมะเร็งต่อมลูกหมาก ท่านควรจะใช้ Diforol เพื่อรักษาโรคลูกหมากอักเสบอย่างรอบด้านเพื่อรักษาให้หายให้เร็วที่สุดและได้ผลลัพธ์ที่ยั่งยืน"), e = 570), 0 != t && ($(".test").animate({
          opacity: 0
      ...
      $(".checkform button").click(function() {
        return "" == $('.checkform input[name="code"]').val() ? ($.magnificPopup.open({
          items: {
            src: "#check-cod-error",
            type: "inline"
          }
        }), $('.checkform input[name="code"]').focus()) : ($(".checkform").find("input").val(""), $.magnificPopup.open({
          items: {
            src: "#check-cod-ok",
            type: "inline"
          }
    ...
    var o = ['มกราคม', 'กุมภาพันธ์', 'มีนาคม', 'เมษายน', 'พฤษภาคม', 'มิถุนายน', 'กรกฎาคม', 'สิงหาคม', 'กันยายน', 'ตุลาคม', 'พฤศจิกายน', 'ธันวาคม'],
      a = new Date;
    a.getDate() < 6 ? a.setMonth(a.getMonth() - 2) : a.setMonth(a.getMonth() - 1), $(".likeclients").text(o[a.getMonth()] + " " + (+a.getFullYear() + 543) + " ปี")
  });
  
var d = new Date();
document.querySelector('.year').innerHTML = d.getFullYear() + 543;